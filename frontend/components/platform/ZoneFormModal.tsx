...
const TASK_PRESETS: {
  ...
  {
    type: 'WATER_WASTE',
    label: 'Water Waste Management (Produces Water)',
    defaultName: 'Water Purification Sector',
    defaultTime: 45,
    color: '#0284c7',
  ...
  {
    type: 'TREE_PLANTING',
    label: 'Tree Planting (Requires Water)',
    defaultName: 'Arborist Eco-Zone',
    defaultTime: 60,
    color: '#16a34a',
  ...
  {
    type: 'CLEANING',
    label: 'Industrial Facility Cleaning',
    defaultName: 'Assembly Bay Sanitization',
    defaultTime: 35,
    color: '#9333ea',
  },
  {
    type: 'DELIVERY',
    label: 'Component Transfer / Delivery',
    defaultName: 'Logistics Buffer Bay',
    defaultTime: 30,
    color: '#ea580c',
  },
  {
    ...
    defaultName: 'Corridor Sensor Array',
    defaultTime: 25,
    color: '#eab308',
  },
];
